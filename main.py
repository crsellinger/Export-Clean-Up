...
def main():
    ...
    Label(root, text="Currency Column (format A:A):").grid(row=1, column=0, sticky="w", padx=8, pady=8)
    Entry(root, textvariable=currency_column).grid(row=1, column=1, sticky="we", padx=8, pady=8)
